...
# Data_Orig = read.csv( "/home/brian/Documents/Bycatch/fleetwide/wcgop data/test_dat.csv" )
# # # Edit bimonth to have more than one level
# Data_Orig[1:5,'bimonth'] = 2

# # Rename to expected format
# Data_Geostat = data.frame('Lat'=Data_Orig[,'avg_lat'], 
#                           'Lon'=Data_Orig[,'avg_long'], 
#                           'AreaSwept_km2'=Data_Orig[,'haul_dur'],
#                           'Vessel'="none", 
#                           'Catch_KG'=Data_Orig[,'response'], 
#                           'Year'=Data_Orig[,'year'])

# # I imagine that `haul_dur` is in log-space, so I'm rescaling here 
# Data_Geostat[,'AreaSwept_km2'] = exp(Data_Orig[,'haul_dur'])
# # show Data_Geostat
# head(Data_Geostat)
...
# # save / load image for minimal ex to Jim
# save.image("/home/brian/Documents/Bycatch/fleetwide/wcgop data/test_dat_err.RData")
load("/home/brian/Documents/Bycatch/fleetwide/wcgop data/test_dat_err.RData")
